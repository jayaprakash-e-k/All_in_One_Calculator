...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Lat Long to UTM Converter']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Lat Long to UTM Converter</h1>
                    <p class="text-gray-600">Convert between latitude/longitude and UTM coordinate systems</p>
                </div>
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-red-300 transition-colors cursor-pointer bg-red-50 border-red-300">
                                        <input type="radio" name="mode" value="latlong-to-utm" class="text-red-600 focus:ring-red-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-red-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="utm-to-latlong" class="text-red-600 focus:ring-red-500">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-red-300 transition-colors cursor-pointer">
                                            <input type="radio" name="hemisphere" value="N" class="text-red-600 focus:ring-red-500" checked>
                                            <span class="text-sm font-medium">Northern</span>
                                        </label>
                                        <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-red-300 transition-colors cursor-pointer">
                                            <input type="radio" name="hemisphere" value="S" class="text-red-600 focus:ring-red-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-red-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="0" class="text-red-600 focus:ring-red-500">
