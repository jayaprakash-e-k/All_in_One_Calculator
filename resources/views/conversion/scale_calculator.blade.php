...
>
    ...
    <section class="py-16 bg-gradient-to-br from-cyan-50 to-white min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Scale Calculator</h1>
                    <p class="text-gray-600">Calculate map scales, ratios and real-world distances</p>
                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer bg-cyan-50 border-cyan-300">
                                        <input type="radio" name="mode" value="find-scale" class="text-cyan-600 focus:ring-cyan-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="find-real" class="text-cyan-600 focus:ring-cyan-500">
                                        <span class="text-sm font-medium">Find Real Distance</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="find-map" class="text-cyan-600 focus:ring-cyan-500">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex">
                                            <input 
                                                type="number" 
                                                id="mapDistance" 
                                                class="flex-1 px-4 py-3 border-2 border-gray-200 rounded-l-lg focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 focus:ring-opacity-50 transition-all duration-200 text-lg font-medium" 
                                                placeholder="e.g., 5"
                                                step="any"
                                                min="0"
                                            >
                                            <select 
                                                id="mapUnit" 
                                                class="px-3 py-3 border-2 border-l-0 border-gray-200 rounded-r-lg focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 focus:ring-opacity-50 transition-all duration-200 bg-white"
                                            >
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input 
                                                type="number" 
                                                id="scaleRatio" 
                                                class="w-full pl-8 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 focus:ring-opacity-50 transition-all duration-200 text-lg font-medium" 
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="0" class="text-cyan-600 focus:ring-cyan-500">
                                        <span class="text-xs font-medium">Whole</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="2" class="text-cyan-600 focus:ring-cyan-500" checked>
                                        <span class="text-xs font-medium">2 decimals</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="4" class="text-cyan-600 focus:ring-cyan-500">
                                        <span class="text-xs font-medium">4 decimals</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="auto" class="text-cyan-600 focus:ring-cyan-500">
