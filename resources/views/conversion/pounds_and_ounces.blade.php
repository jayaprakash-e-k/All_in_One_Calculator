...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Pounds and Ounces Converter']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Pounds and Ounces Converter</h1>
                    <p class="text-gray-600">Convert between imperial and metric weight units</p>
                </div>
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" id="autoNormalize" class="text-teal-600 focus:ring-teal-500 rounded" checked>
