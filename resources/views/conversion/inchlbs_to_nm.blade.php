        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">in-lbs ↔ Nm Converter</h1>
                    <p class="text-gray-600">Bidirectional torque unit conversion</p>
                </div>
