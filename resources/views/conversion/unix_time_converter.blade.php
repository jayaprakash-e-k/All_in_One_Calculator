        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Convert Unix timestamps to human-readable dates</p>
                </div>
                    ...
                    <div class="p-8">
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer bg-orange-50 border-orange-300">
                                        <input type="radio" name="mode" value="unix-to-date" class="text-orange-600 focus:ring-orange-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="date-to-unix" class="text-orange-600 focus:ring-orange-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer bg-orange-50 border-orange-300">
                                        <input type="radio" name="format" value="seconds" class="text-orange-600 focus:ring-orange-500" checked>
                                        <div class="text-left">
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                        <input type="radio" name="format" value="milliseconds" class="text-orange-600 focus:ring-orange-500">
                                        <div class="text-left">
