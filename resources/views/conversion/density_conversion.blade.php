...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Density Conversion Calculator']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Density Conversion Calculator</h1>
                    <p class="text-gray-600">Convert between different density units for materials and substances</p>
                </div>
