...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Ounces to Cups Converter']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Ounces to Cups Converter</h1>
                    <p class="text-gray-600">Convert between fluid ounces and cups for cooking</p>
                </div>
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <label class="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="direction" value="oz-to-cups" class="text-cyan-600 focus:ring-cyan-500" checked>
                                        <span class="text-sm font-medium">Ounces → Cups</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="direction" value="cups-to-oz" class="text-cyan-600 focus:ring-cyan-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <label class="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="cupType" value="us" class="text-cyan-600 focus:ring-cyan-500" checked>
                                        <div>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="cupType" value="metric" class="text-cyan-600 focus:ring-cyan-500">
                                        <div>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-lg hover:border-cyan-300 transition-colors cursor-pointer">
                                        <input type="radio" name="cupType" value="imperial" class="text-cyan-600 focus:ring-cyan-500">
                                        <div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center space-x-2">
                                    <input type="checkbox" id="showFractions" class="text-cyan-600 focus:ring-cyan-500 rounded">
