...
<head>
    <meta charset="UTF-8">
    <title>Ounces to Cups Converter</title>
...
<div class="w-full max-w-lg mx-auto bg-white/90 p-8 rounded-2xl shadow-2xl backdrop-blur-md">
    <h1 class="text-3xl font-extrabold text-center text-blue-700 mb-6 tracking-tight drop-shadow">Oz to Cups Converter</h1>

    <form class="space-y-6">
        <div>
            <label class="block text-gray-700 font-semibold mb-1">Enter Volume (Fluid Ounces)</label>
            <input type="number" id="oz" class="w-full p-3 border-2 border-blue-200 rounded-lg" placeholder="e.g., 16">
        </div>
    </form>
...
<script>
    ...
    ozInput.addEventListener('input', convert);
