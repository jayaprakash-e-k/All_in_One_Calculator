...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Years to Decades Calculator']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Years to Decades Calculator</h1>
                    <p class="text-gray-600">Convert years to decades, centuries, and millennia</p>
                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-rose-300 transition-colors cursor-pointer bg-rose-50 border-rose-300">
                                        <input type="radio" name="mode" value="years-to-periods" class="text-rose-600 focus:ring-rose-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-rose-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="periods-to-years" class="text-rose-600 focus:ring-rose-500">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                        <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-rose-300 transition-colors cursor-pointer">
                                            <input type="checkbox" name="showAge" class="text-rose-600 focus:ring-rose-500" checked>
                                            <span class="text-sm font-medium">Age Context</span>
                                        </label>
                                        <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-rose-300 transition-colors cursor-pointer">
                                            <input type="checkbox" name="showHistorical" class="text-rose-600 focus:ring-rose-500" checked>
                                            <span class="text-sm font-medium">Historical</span>
                                        </label>
                                        <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-rose-300 transition-colors cursor-pointer">
                                            <input type="checkbox" name="showGenerations" class="text-rose-600 focus:ring-rose-500" checked>
