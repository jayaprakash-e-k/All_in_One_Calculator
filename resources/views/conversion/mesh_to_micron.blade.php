...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Mesh to Micron Converter']
    ]" />

    <!-- Main Calculator Section -->
    <section class="py-16 bg-gradient-to-br from-sky-50 to-white min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Mesh to Micron Converter</h1>
                    <p class="text-gray-600">Convert US standard mesh sizes to micron particle sizes</p>
                </div>
