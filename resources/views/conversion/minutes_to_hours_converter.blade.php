        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Minutes to Hours Converter</h1>
                    <p class="text-gray-600">Convert minutes to hours and vice versa</p>
                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer bg-blue-50 border-blue-300">
                                        <input type="radio" name="mode" value="min-to-hour" class="text-blue-600 focus:ring-blue-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="hour-to-min" class="text-blue-600 focus:ring-blue-500">
                            ...
                            <div class="space-y-2 hidden">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="checkbox" name="showDecimal" class="text-blue-600 focus:ring-blue-500" checked>
                                        <span class="text-sm font-medium">Decimal</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="checkbox" name="showHourMin" class="text-blue-600 focus:ring-blue-500" checked>
                                        <span class="text-sm font-medium">Hours:Minutes</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="checkbox" name="showWorded" class="text-blue-600 focus:ring-blue-500" checked>
