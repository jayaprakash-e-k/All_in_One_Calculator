        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Feet & Inches Calculator</h1>
                    <p class="text-gray-600">Convert imperial measurements to metric units with precision</p>
                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="relative">
                                        <input 
                                            type="number" 
                                            id="feet" 
                                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-violet-500 focus:ring-2 focus:ring-violet-200 focus:ring-opacity-50 transition-all duration-200 text-lg font-medium" 
                                            placeholder="0"
                                            step="any"
                                            min="0"
                                        >
