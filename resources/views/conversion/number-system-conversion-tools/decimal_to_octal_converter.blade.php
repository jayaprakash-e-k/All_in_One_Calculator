                                        ...
                                        <form class="space-y-5 rounded-xl border border-slate-200 bg-white p-4 shadow-sm focus-within:ring-2 focus-within:ring-slate-200 lg:sticky lg:top-24 lg:z-20 lg:max-h-[calc(100vh-7.5rem)] lg:overflow-y-auto" id="calculatorForm">
                                                                            ...
                                                                            <div class="space-y-2">
                                                                                ...
                                                                                <div class="grid grid-cols-2 gap-2">
                                                                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer bg-orange-50 border-orange-300">
                                                                                        <input type="radio" name="mode" value="decimal-to-octal" class="text-orange-600 focus:ring-slate-200" checked>
                                                                                    ...
                                                                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="radio" name="mode" value="octal-to-decimal" class="text-orange-600 focus:ring-slate-200">
                                                                            ...
                                                                            <div class="space-y-2">
                                                                                ...
                                                                                <div class="grid grid-cols-2 gap-2">
                                                                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="checkbox" name="showPrefix" class="text-orange-600 focus:ring-slate-200" checked>
                                                                                        <span class="text-sm font-medium">Show 0o prefix</span>
                                                                                    </label>
                                                                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="checkbox" name="showSteps" class="text-orange-600 focus:ring-slate-200" checked>
                                                                            ...
                                                                            <div class="space-y-2">
                                                                                ...
                                                                                <div class="grid grid-cols-3 gap-2">
                                                                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="radio" name="context" value="general" class="text-orange-600 focus:ring-slate-200" checked>
                                                                                        <span class="text-sm font-medium">General</span>
                                                                                    </label>
                                                                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="radio" name="context" value="unix" class="text-orange-600 focus:ring-slate-200">
                                                                                        <span class="text-sm font-medium">Unix/Linux</span>
                                                                                    </label>
                                                                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors cursor-pointer">
                                                                                        <input type="radio" name="context" value="digital" class="text-orange-600 focus:ring-slate-200">
