...
>
    ...
    <section class="py-16 bg-gradient-to-br from-emerald-50 to-white min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Coordinates Converter</h1>
                    <p class="text-gray-600">Convert between different coordinate systems and formats</p>
                </div>
