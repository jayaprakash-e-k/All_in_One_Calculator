        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Binary Converter</h1>
                    <p class="text-gray-600">Convert binary numbers to decimal and other number systems</p>
                </div>
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer bg-blue-50 border-blue-300">
                                        <input type="radio" name="mode" value="binary-to-decimal" class="text-blue-600 focus:ring-blue-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="decimal-to-binary" class="text-blue-600 focus:ring-blue-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="checkbox" name="addSpacing" class="text-blue-600 focus:ring-blue-500" checked>
                                        <span class="text-sm font-medium">Add 4-bit spacing</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="checkbox" name="showBitPosition" class="text-blue-600 focus:ring-blue-500" checked>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="bitWidth" value="8" class="text-blue-600 focus:ring-blue-500" checked>
                                        <span class="text-sm font-medium">8-bit</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="bitWidth" value="16" class="text-blue-600 focus:ring-blue-500">
                                        <span class="text-sm font-medium">16-bit</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="bitWidth" value="32" class="text-blue-600 focus:ring-blue-500">
                                        <span class="text-sm font-medium">32-bit</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                                        <input type="radio" name="bitWidth" value="auto" class="text-blue-600 focus:ring-blue-500">
