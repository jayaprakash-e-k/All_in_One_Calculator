...
>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Million to Billion Converter']
    ]" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Million to Billion Converter</h1>
                    <p class="text-gray-600">Convert millions to billions and large Western number units</p>
                </div>
                        ...
                        <form class="space-y-6" id="calculatorForm">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer bg-purple-50 border-purple-300">
                                        <input type="radio" name="mode" value="million-to-billion" class="text-purple-600 focus:ring-purple-500" checked>
                                    ...
                                    <label class="flex items-center space-x-2 p-3 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="mode" value="billion-to-million" class="text-purple-600 focus:ring-purple-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="system" value="short" class="text-purple-600 focus:ring-purple-500" checked>
                                        <span class="text-sm font-medium">Short Scale (US)</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="system" value="long" class="text-purple-600 focus:ring-purple-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="1" class="text-purple-600 focus:ring-purple-500">
                                        <span class="text-xs font-medium">1 decimal</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="3" class="text-purple-600 focus:ring-purple-500" checked>
                                        <span class="text-xs font-medium">3 decimals</span>
                                    </label>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors cursor-pointer">
                                        <input type="radio" name="precision" value="6" class="text-purple-600 focus:ring-purple-500">
